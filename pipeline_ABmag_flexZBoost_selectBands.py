...
lePhare_cut    = 10       ### Number of sources used to satisfy LePhare's input dataset. If `AUTO_ADAPT = YES`, 
...
PHOTOMETRY_DeepField_noisy_lpReference_iBandCut_trainingCut = PHOTOMETRY_DeepField_noisy_lpReference_iBandCut.iloc[:lePhare_cut]
